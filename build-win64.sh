...
cp native/build-x64/src/Release/DeadMoore.exe build/win-x64/
cp build/libs/DeadMoore.jar build/win-x64/
...
echo DeadMoore.exe 64bit sha256sum
sha256sum build/win-x64/DeadMoore.exe

dumpbin //HEADERS build/win-x64/DeadMoore.exe
