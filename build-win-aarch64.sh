...
cp native/build-aarch64/src/Release/DeadMoore.exe build/win-aarch64/
cp build/libs/DeadMoore.jar build/win-aarch64/
...
echo DeadMoore.exe aarch64 sha256sum
sha256sum build/win-aarch64/DeadMoore.exe

dumpbin //HEADERS build/win-aarch64/DeadMoore.exe
